              ...
              <Card key={index} className="opacity-50">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-3 h-3 rounded-full bg-accent-primary opacity-60"></div>
          ...
          <Card key={category.id} className="hover:shadow-md transition-shadow">
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    {category.color && (
                      <div 
                        className="w-3 h-3 rounded-full border border-accent-border"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Products</span>
                  <Badge className="text-xs bg-accent-secondary text-accent-secondary-foreground border-accent-border">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className={(productCounts[category.name] || 0) > 0 ? 'text-accent-primary border-accent-border' : 'text-muted-foreground border-border'}>
